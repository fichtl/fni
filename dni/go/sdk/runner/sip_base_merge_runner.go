...
type SIPBaseMergeExecutor struct {
	RunnerName string
	Options    SIPBaseMergeOptions
}

type SIPBaseMergeOptions struct {
...
func NewSIPBaseMergeExecutor(runner string, options map[string]interface{}) Executor {
	...
	e := &SIPBaseMergeExecutor{}
	e.RunnerName = runner
	e.Options = opts
	return e
}

func (e *SIPBaseMergeExecutor) Start(values []*flowmng.DataSpec) ([]flowmng.DataSpec, error) {
	//cast inputs
...
func (e *SIPBaseMergeExecutor) Stop() error {
	return nil
}

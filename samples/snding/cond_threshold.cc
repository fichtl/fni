...
void inject_after(dni::Graph* g, int after, int n, int interval)
{
        ...
        uint64_t stat = 4 /*600*/;   // length
        std::vector<uint64_t> ___thresholds = {6, 500};
        std::vector<float_t> ___scores = {0.2, 0.1};
        std::vector<uint64_t> ___cond_thresholds = {2000};
        std::vector<uint64_t> ___cond_values = {1000 /*2000*/ /*1000*/};   // countTotal

...
void inject_after(dni::Graph* g, int after, int n, int interval)
{
        ...
        */
        ...
        g->AddDatumToInputStream("host_nic_name1", dni::Datum("A10-1#sno2"s));
        ...
        g->AddDatumToInputStream("host_nic_name2", dni::Datum("A10-2#sno2"s));
...
int main()
{
        ...
        const std::string& proto = "samples/dni/tasks/snding/testdata/dms_rules_2.pbtxt";

...
int main()
{
        ...
        std::string logFileName = "sip-base-merge-dedup.log";
        std::string spdlogFileName = "sip-base-merge-dedup-spd.log";
        ...
        const std::string& proto =  relatedpath + "testdata/sip_base_merge_dedup.pbtxt";

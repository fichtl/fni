...
class TwoWayCountOppositeTask: public dni::TaskBase {
public:
        TwoWayCountOppositeTask(): name_("TwoWayCountOppositeTask") {}
        ~TwoWayCountOppositeTask() override {}
...
REGISTER(TwoWayCountOppositeTask)

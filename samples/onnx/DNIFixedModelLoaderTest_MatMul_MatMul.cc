...
# MatMul
add = helper.make_node('MatMul', ['c', 'b'], ['output'])
# graph and model
...
# print(model)
onnx.save(model, 'model_2_5_x_5_3_x_3_2.onnx')




model_path = "./model_2_5_x_5_3_x_3_2.onnx"
...
onnx.save(converted_model, 'model_2_5_x_5_3_x_3_2_v19.onnx')
